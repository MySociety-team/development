      ...
      async () => {
        ...
        try {
          ...
          setTransparencyError(
            err?.response?.data?.message ||
              err?.message ||
              "Failed to load maintenance transparency"
          );
...
console.log("RAZORPAY VERIFY DEBUG", {
  ...
  returnedOrderId: response.razorpay_order_id,
  ...
  signatureReceived: Boolean(
    response.razorpay_signature
              ...
              setSuccess(
                `Maintenance payment for ${bill.month} was successful!`
              );
        ...
        <section>
          ...
          <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-[0_14px_45px_-28px_rgba(15,23,42,0.3)]">
            ...
            {transparencyLoading ? (
              ...
              <div className="p-10 text-center text-sm text-slate-500">
                No maintenance information available for{" "}
                {transparencyMonth}.
              </div>
          ...
          <p className="mt-3 text-xs text-slate-400">
            Only flat number, bill amount, payment status, and payment date are shown for transparency. Private transaction details are not displayed.
          </p>
